...
/* package haskell-tcp-server-0.1.0.0 */
#ifndef VERSION_haskell_tcp_server
#define VERSION_haskell_tcp_server "0.1.0.0"
#endif /* VERSION_haskell_tcp_server */
#ifndef MIN_VERSION_haskell_tcp_server
#define MIN_VERSION_haskell_tcp_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_tcp_server */
...
#define CURRENT_COMPONENT_ID "haskell-tcp-server-0.1.0.0-inplace-haskell-tcp-server"
